...
Object.defineProperty(exports, "__esModule", { value: true });
var $ = require("jquery");
var IO = require("./diagrams-io");
/** HTML IO module that expresses the JSON of the underlying diagam. */
var DiagramsJSONIOModule = (function (_super) {
    __extends(DiagramsJSONIOModule, _super);
    function DiagramsJSONIOModule() {
        var _this = _super.call(this) || this;
        _this.importRewriteDiagram = function (diagram) {
            $(_this.UISelector).val(diagram.toJSON());
        };
        _this.onJSONChange = function () {
            var parsed;
            try {
                parsed = JSON.parse($(_this.UISelector).val());
            }
            catch (e) {
                // TODO flag when JSON is invalid
            }
            if (parsed) {
                _this.outputDiagram.importRewriteDiagram(parsed);
            }
        };
        return _this;
    }
    return DiagramsJSONIOModule;
}(IO.DiagramIOHTMLModule));
exports.DiagramsJSONIOModule = DiagramsJSONIOModule;

},{"./diagrams-io":3,"jquery":16}],3:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
Object.defineProperty(exports, "__esModule", { value: true });
var Diagrams = require("./diagrams.js");
...
var DiagramIOModule = (function () {
    function DiagramIOModule() {
        this.outputDiagram = new Diagrams.Diagram();
    }
    return DiagramIOModule;
}());
exports.DiagramIOModule = DiagramIOModule;
// IO Pipes are an exception; they should be used without extension
/** Joins upstream callers to downstream listeners */
var IOPipe = (function () {
    function IOPipe(upstream, downstream) {
        var _this = this;
        this.upstreamChange = function (diagram) {
            _this.downstreamDiagram.importRewriteDiagram(diagram);
        };
        this._upstreamDiagram = upstream;
        this._downstreamDiagram = downstream;
        this._upstreamDiagram.subscribe(this);
    }
    Object.defineProperty(IOPipe.prototype, "downstreamDiagram", {
        get: function () {
    ...
    Object.defineProperty(IOPipe.prototype, "upstreamDiagram", {
        get: function () {
...
exports.IOPipe = IOPipe;
/** Simple IO module with a jquery selector */
var DiagramIOHTMLModule = (function (_super) {
    __extends(DiagramIOHTMLModule, _super);
    function DiagramIOHTMLModule() {
...
},{"./diagrams.js":4}],4:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
    ...
    function Diagram() {
        ...
        _this.fireChange = function () {
            for (var _i = 0, _a = _this.listeners; _i < _a.length; _i++) {
                var l = _a[_i];
                l.upstreamChange(_this);
            }
        };
        // Importing
        /** Add a single edge */
        _this.importEdge = function (edge) {
            _this.importEdgeDontFire(edge);
            _this.fireChange();
        };
        _this.importEdgeDontFire = function (edge) {
            _this.edges.push(edge);
            _this.edgeById[edge.id] = edge;
        };
        /** Add a single vertex */
        _this.importVertex = function (vertex) {
            _this.importVertexDontFire(vertex);
            _this.fireChange();
        };
        _this.importVertexDontFire = function (vertex) {
            _this.vertices.push(vertex);
            _this.vertexById[vertex.id] = vertex;
        };
        /** Rewrite the existing diagram data with new data */
        _this.importRewriteDiagram = function (diagram) {
            var previousToJSON = _this.toJSON();
            var newJSONparse;
            if (diagram.toJSON) {
                // If the passed object is a fully formed diagram
                // then is has methods attached we can call
                newJSONparse = JSON.parse(diagram.toJSON());
            }
            else {
            ...
            _this.vertices = [];
            _this.vertexById = {};
            for (var _i = 0, _a = newJSONparse.vertices; _i < _a.length; _i++) {
                var vertex = _a[_i];
                var v = new Vertex(vertex.pos);
                v.id = vertex.id;
                v.data = vertex.data;
                _this.importVertexDontFire(v);
            }
            for (var _b = 0, _c = newJSONparse.edges; _b < _c.length; _b++) {
                var edge = _c[_b];
                var e = new Edge(_this.vertexById[edge.start], _this.vertexById[edge.end]);
                e.id = edge.id;
                e.data = edge.data;
                _this.importEdgeDontFire(e);
            }
            if (_this.toJSON() !== previousToJSON) {
                _this.fireChange();
            }
        };
        _this.edges = [];
...
Object.defineProperty(exports, "__esModule", { value: true });
var Diagrams = require("./diagrams.js");
var DiagramsIO = require("./diagrams-io.js");
var $ = require("jquery");
var SVG = require("svgjs");
var FreehandOnSVGIOModule = require("./zx-io-draw.js");
var ZXJSONIOModule = require("./zx-io-json.js");
var ZXSVGIOModule = require("./zx-io-svg.js");
var DiagramsJSONModule = require("./diagrams-io-json.js");
var ZXTikZIOModule = require("./zx-io-tikz.js");
var D = new Diagrams.Diagram();
$(document).ready();
var pipe = DiagramsIO.IOPipe;
var bindToD = function (IOModule) {
    new pipe(D, IOModule);
...
},{"./diagrams-io-json.js":2,"./diagrams-io.js":3,"./diagrams.js":4,"./zx-io-draw.js":9,"./zx-io-json.js":10,"./zx-io-svg.js":11,"./zx-io-tikz.js":12,"jquery":16,"svgjs":17}],7:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
/**
 ...
 * @param end {x,y} point
 */
function smoothWithTips(start, waypointsInBetween, end) {
    return smooth([start].concat(waypointsInBetween).concat([end]));
}
exports.smoothWithTips = smoothWithTips;
...
function smooth(allWaypoints) {
    ...
    var pathCommand = "";
    var startPos = allWaypoints[0];
    var endPos = allWaypoints[allWaypoints.length - 1];
    var tangents = [];
    ...
    normaliseAndPushToTangents(allWaypoints[1].x - startPos.x, allWaypoints[1].y - startPos.y);
    // waypoint i -> waypoint i+1
    for (var i = 1; i < allWaypoints.length - 1; i++) {
        normaliseAndPushToTangents(allWaypoints[i + 1].x - allWaypoints[i - 1].x, allWaypoints[i + 1].y - allWaypoints[i - 1].y);
    }
    // waypoint last -> vertex end
    normaliseAndPushToTangents(endPos.x - allWaypoints[i - 1].x, endPos.y - allWaypoints[i - 1].y);
    //Calculate path data:
    ...
    for (var i = 1; i < allWaypoints.length - 1; i++) {
        var lastNode = allWaypoints[i - 1];
        var focusNode = allWaypoints[i];
        var nextNode = allWaypoints[i + 1];
        var dPre = {
 ...
 */
function recogniseNodeDataSimple(waypointLists) {
    ...
    var distanceAB = function (a, b) {
        var dx = a.x - b.x;
        var dy = a.y - b.y;
        return Math.pow(dx * dx + dy * dy, 0.5);
    };
    var toPos = function (a) {
        return {
            x: a[0], y: a[1]
        };
    };
    ...
    for (var i = 0; i < outsideArray.length; i++) {
        ...
        circumference += distanceAB({ x: focusNode[0], y: focusNode[1] }, { x: nextNode[0], y: nextNode[1] });
    ...
    var curveNeeded = 0.1;
    var rectangularEccentricity = Math.min(bboxWidth, bboxHeight) / Math.max(bboxWidth, bboxHeight);
    // Is it square?
...
exports.recogniseNodeDataSimple = recogniseNodeDataSimple;
/** Defunct function, kept for cannibalisation */
function recogniseNodeDataComplex(waypointLists) {
    var allPoints = waypointLists.reduce(function (a, b) {
        return a.concat(b);
    });
    var data = {
    ...
    var angleFromMidpoint = function (a) {
        var modifier = 0;
        if (a.y < someMid.y) {
            modifier = Math.PI;
        }
...
exports.recogniseNodeDataComplex = recogniseNodeDataComplex;
var angleAFromB = function (a, midPoint) {
    var modifier = 0;
    if (a.y < midPoint.y) {
        modifier = Math.PI;
    }
...
},{"./zx-theory.js":14,"convexhull-js":15}],9:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var waypointsToSmoothPath = require("./waypoints-to-smooth-path.js");
var RDP = require("./RamerDouglasPeucker.js");
var ZX = require("./zx-theory.js");
var ZXIO = require("./zx-io.js");
var recognise = require("./zx-freehand-node.js");
/** Types of object expected to be drawn. */
var ENUMSVGDrawingType;
(function (ENUMSVGDrawingType) {
    ENUMSVGDrawingType[ENUMSVGDrawingType["PATH"] = 0] = "PATH";
    ENUMSVGDrawingType[ENUMSVGDrawingType["CIRCLE"] = 1] = "CIRCLE";
    ENUMSVGDrawingType[ENUMSVGDrawingType["RECT"] = 2] = "RECT";
})(ENUMSVGDrawingType || (ENUMSVGDrawingType = {}));
/** An object ready to be drawn in SVG. */
var SVGDrawableElement = (function () {
    function SVGDrawableElement() {
    }
    return SVGDrawableElement;
}());
...
var FreehandOnSVGIOModule = (function (_super) {
    ...
    function FreehandOnSVGIOModule() {
        var _this = _super.call(this) || this;
        _this.paths = [];
        _this.defaultStrokeData = {
            color: "black",
            width: 1
        };
        _this.closingEdgeEdgeDistance = 20;
        _this.closingEdgeVertexDistance = 20;
        // Mouse Events
        ...
        _this.createSVGHolder = function (selector) {
            _this.svgElement = SVG(selector);
            _this.svgElement.viewbox({ x: 0, y: 0, width: 500, height: 500 });
            // Mouse events
        ...
        _this.endPath = function () {
            ...
            _this.paths.push(svgPathWithData);
            _this.currentPath = "";
            _this.takeInput = false;
            // Update the private virtual diagram
            if (_this.diagUserDrawingOnly) {
                _this.importPathAsObject(s);
            }
            // Try and tie up loose edges, etc. in the virtual diagram
            _this.mergeNearbyVertices();
            _this.pushChangesDownstream();
            _this.drawAllShapes();
        };
        _this.pushChangesDownstream = function () {
            ...
            var vertexByID = {};
            var verticesAddedToPacket = {};
            for (var _i = 0, _a = _this.diagMergedVertices.vertices; _i < _a.length; _i++) {
                var vertex = _a[_i];
            ...
            for (var _b = 0, _c = _this.diagMergedVertices.edges; _b < _c.length; _b++) {
                var edge = _c[_b];
            ...
            _this.outputDiagram.importRewriteDiagram(packetDiagram);
        };
        /**
         ...
         */
        _this.importPathAsObject = function (pathAsString) {
            var originalPath = pathAsString;
            pathAsString = pathAsString
                .replace(/[a-zA-Z]/g, '')
                .replace(/[\s,]+/g, ' ')
                .trim();
            var interpolatedPath = pathInterpolate(pathAsString, ZXIO.defaultRadius / 10);
            ...
            var smootherRDP = RDP
                ...
                .concat([interpolatedPath.end]);
            var nodeData = recognise.recogniseNodeDataSimple([pathToPosnList(RDPWaypoints)]);
            var r;
            var tempVertexData = {
                inferred: true,
                label: "",
            ...
            if (nodeData.type === ZX.VERTEXTYPES.WIRE ||
                ...
                _this.diagUserDrawingOnly.importVertex(vStart);
                var vEnd = new Diagrams.Vertex(end);
                vEnd.data = tempVertexData;
                _this.diagUserDrawingOnly.importVertex(vEnd);
                ...
                r.data = edgeData;
                _this.diagUserDrawingOnly.importEdge(r);
            }
            else {
                ...
                r.data = nodeData;
                _this.diagUserDrawingOnly.importVertex(r);
            }
            return r;
        };
        /** Overwrite the internal diagram with new data. */
        _this.importRewriteDiagram = function (diagram) {
            if (diagram.toJSON() !== _this.outputDiagram.toJSON()) {
                _this.paths = [];
                for (var _i = 0, _a = diagram.edges; _i < _a.length; _i++) {
                    ...
                    switch (data.type) {
                        case ZX.EDGETYPES.PLAIN:
                            ...
                            _this.paths.push(edgePath);
                            break;
                    }
                }
                for (var _b = 0, _c = diagram.vertices; _b < _c.length; _b++) {
                    var vertex = _c[_b];
                    var data_1 = vertex.data;
                    var pos = vertex.pos;
                    var radius = (data_1.radius) || ZXIO.defaultRadius;
                    switch (data_1.type) {
                        ...
                        case ZX.VERTEXTYPES.X:
                            ...
                            _this.paths.push(xNode);
                            break;
                    }
                }
                _this.drawAllShapes();
                _this.diagUserDrawingOnly.importRewriteDiagram(diagram);
                _this.diagMergedVertices.importRewriteDiagram(diagram);
                _this.outputDiagram.importRewriteDiagram(diagram);
            }
        };
        /**
                ...
                switch (shape.type) {
                    case ENUMSVGDrawingType.PATH:
                        if (shape.dataPath.path && shape.dataPath.path.length > 0) {
                            ...
                            svgElementCreated = svg.path(waypointsToSmoothPath.smooth(shape.dataPath.RDPWaypoints));
                        }
                        else {
                        }
                        break;
        ...
        _this.mergeNearbyVertices = function () {
            ...
            var swapEdgeVertex = function (D, oldVertex, newVertex) {
                for (var _i = 0, _a = D.edges; _i < _a.length; _i++) {
                    var edge = _a[_i];
            ...
            for (var _b = 0, inferredVertices_1 = inferredVertices; _b < inferredVertices_1.length; _b++) {
                var infVertex = inferredVertices_1[_b];
                var closestDist = Math.pow(_this.closingEdgeVertexDistance, 2) + 1;
                var closestFixedVertex = null;
                var dist = 0;
                for (var _c = 0, fixedVertices_1 = fixedVertices; _c < fixedVertices_1.length; _c++) {
                    var fixVertex = fixedVertices_1[_c];
                ...
                if (closestFixedVertex) {
                    swapEdgeVertex(_this.diagMergedVertices, infVertex, closestFixedVertex);
                }
            }
            // Try and join any inferred vertex to another inferred vertex
            for (var i = 0; i < inferredVertices.length; i++) {
                var infVertex1 = inferredVertices[i];
                var closestDist = Math.pow(_this.closingEdgeEdgeDistance, 2);
                var dist = 0;
                var closestInfVertex = null;
                for (var j = i + 1; j < inferredVertices.length; j++) {
                    var infVertex2 = inferredVertices[j];
                ...
                if (closestInfVertex) {
                    ...
                    _this.diagMergedVertices.importVertex(vx);
                    swapEdgeVertex(_this.diagMergedVertices, closestInfVertex, vx);
                    swapEdgeVertex(_this.diagMergedVertices, infVertex1, vx);
                }
                else {
                    // create an input vertex to join to
                    var vx = new Diagrams.Vertex(infVertex1.pos);
                    vx.data = {
        ...
        _this.diagUserDrawingOnly = new Diagrams.Diagram();
        _this.diagMergedVertices = new Diagrams.Diagram();
        _this.outputDiagram = new Diagrams.Diagram();
        return _this;
    }
...
},{"./RamerDouglasPeucker.js":1,"./diagrams.js":4,"./path-interpolate":5,"./waypoints-to-smooth-path.js":7,"./zx-freehand-node.js":8,"./zx-io.js":13,"./zx-theory.js":14,"svgjs":17}],10:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var ZXJSONIOModule = (function (_super) {
    ...
    function ZXJSONIOModule() {
        var _this = _super.call(this) || this;
        /** Rewrite the internal diagram data */
        _this.importRewriteDiagram = function (diagram) {
            $(_this.UISelector).val(JSON.stringify(JSON.parse(diagramToQuantoGraph(diagram)), undefined, 2));
        };
        ...
        _this.onJSONChange = function () {
            ...
            if (parsed) {
                var packetDiagram = new Diagrams.Diagram();
                var vertexLookup = {};
                for (var wireVertexName in parsed.wire_vertices) {
                    var wireVertex = parsed.wire_vertices[wireVertexName];
                    var coordArr = wireVertex.annotation.coord;
                    var coord = {
                        x: coordArr[0],
                        y: coordArr[1]
                    };
                    var dummyVertex = new Diagrams.Vertex(coord);
                ...
                for (var nodeVertexName in parsed.node_vertices) {
                    var nodeVertex = parsed.node_vertices[nodeVertexName];
                ...
                for (var edgeName in parsed.undir_edges) {
                    var edge = parsed.undir_edges[edgeName];
                    var sourceVertex = vertexLookup[edge.src];
                    var targetVertex = vertexLookup[edge.tgt];
                    var dummyEdge = new Diagrams.Edge(sourceVertex, targetVertex);
                    var data = {
...
var diagramToQuantoGraph = function (diagram) {
    var output = {
        node_vertices: {},
        undir_edges: {},
        wire_vertices: {}
    ...
    for (var _i = 0, _a = diagram.vertices; _i < _a.length; _i++) {
        var vertex = _a[_i];
        if (vertex.data) {
    ...
    // Then edges
    for (var _b = 0, _c = diagram.edges; _b < _c.length; _b++) {
        var edge = _c[_b];
...
},{"./diagrams.js":4,"./zx-io.js":13,"./zx-theory.js":14,"jquery":16}],11:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var waypointsToSmoothPath = require("./waypoints-to-smooth-path");
var ZX = require("./zx-theory");
var ZXIO = require("./zx-io");
/** IO module for SVG rendering of a diagram */
var ZXSVGIOModule = (function (_super) {
    __extends(ZXSVGIOModule, _super);
    function ZXSVGIOModule() {
        var _this = _super.call(this) || this;
        /** Overwrite internal data with new diagram */
        _this.importRewriteDiagram = function (diagram) {
            _this.internalDiagram.importRewriteDiagram(diagram);
            _this.toZXSVG(_this.internalDiagram);
            _this.outputDiagram.importRewriteDiagram(_this.internalDiagram);
        };
        /** Fires when an element is clickes */
        _this.clickedElement = function (e) {
            e.preventDefault();
            if (e.srcElement.dataset) {
                var clickedID = e.srcElement.dataset["id"];
            }
            var getElementById = function (id) {
                if (_this.internalDiagram.edgeById[id]) {
                    return _this.internalDiagram.edgeById[id];
                }
                else if (_this.internalDiagram.vertexById[id]) {
                    return _this.internalDiagram.vertexById[id];
                }
                else {
                    return null;
                }
        ...
        _this.toZXSVG = function (diagram) {
            ZXToSVG(diagram, _this.SVG, _this.clickedElement);
        };
        _this.internalDiagram = new Diagrams.Diagram();
        return _this;
    }
 ...
 */
function ZXToSVG(diagram, svgContainer, clickHandler) {
    svgContainer.clear();
    var s = "";
    var idToElement = {};
    var vertexByID = {};
    ...
    for (var _b = 0, _c = diagram.edges; _b < _c.length; _b++) {
        var edge = _c[_b];
        var startPos = vertexByID[edge.start].pos;
        var endPos = vertexByID[edge.end].pos;
        var pathCommand = "";
        pathCommand += "M" + startPos.x + " " + startPos.y + " ";
    ...
    for (var _d = 0, _e = diagram.vertices; _d < _e.length; _d++) {
        var vertex = _e[_d];
        if (vertex.data) {
            var vdata = vertex.data;
...
exports.ZXToSVG = ZXToSVG;

},{"./diagrams":4,"./waypoints-to-smooth-path":7,"./zx-io":13,"./zx-theory":14}],12:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var NODESTYLES;
(function (NODESTYLES) {
    NODESTYLES[NODESTYLES["GREENNODE"] = 0] = "GREENNODE";
    NODESTYLES[NODESTYLES["REDNODE"] = 1] = "REDNODE";
    NODESTYLES[NODESTYLES["INPUTOUTPUT"] = 2] = "INPUTOUTPUT";
    NODESTYLES[NODESTYLES["WIRE"] = 3] = "WIRE";
    NODESTYLES[NODESTYLES["HADAMARD"] = 4] = "HADAMARD";
    NODESTYLES[NODESTYLES["BOX"] = 5] = "BOX";
    NODESTYLES[NODESTYLES["NONE"] = 6] = "NONE";
})(NODESTYLES || (NODESTYLES = {}));
/** Allowed styles of edge */
var EDGESTYLES;
(function (EDGESTYLES) {
    EDGESTYLES[EDGESTYLES["PLAIN"] = 0] = "PLAIN";
...
function ZXToTikZ(diagram) {
    ...
    for (var _d = 0, nodeList_1 = nodeList; _d < nodeList_1.length; _d++) {
        var node = nodeList_1[_d];
        var style = nodeStyleLookup[node.style];
        var label = node.label.length > 0 ? "$" + node.label + "$" : "";
    ...
    for (var _e = 0, edgeList_1 = edgeList; _e < edgeList_1.length; _e++) {
        var edge = edgeList_1[_e];
        var style = edgeStyleLookup[edge.style];
        s += "\t\\draw[-] (" + edge.start + ") to (" + edge.end + ");" + '\n';
    }
    s += "\\end{pgfonlayer}" + '\n';
    return s;
}
exports.ZXToTikZ = ZXToTikZ;
/** Import from the given TikZ code into a diagram */
function TikZtoZX(inputString) {
    var d = new Diagrams.Diagram();
    // Gather all the nodes:
    var regNodeMatch = /\\node\s*\[style=(.*)\]\s*\((.*)\)\s*at\s*\((.*)\s*,\s*(.*)\)\s*{(.*)}\s*;/gim;
    var nodeMatches = regNodeMatch.exec(inputString);
    while (nodeMatches != null) {
        var style = nodeMatches[1];
        var id = nodeMatches[2];
        var pos = {
            x: parseFloat(nodeMatches[3]),
            y: parseFloat(nodeMatches[4])
        };
        var label = nodeMatches[5];
        var v = new Diagrams.Vertex(pos);
        v.id = id;
        var data = {
            label: label,
    ...
    var regEdgeMatch = /\\draw\s*\[(.*)\]\s*\((.*)\)\s*to\s*\((.*)\)\s*;/gim;
    var edgeMatches = regEdgeMatch.exec(inputString);
    while (edgeMatches != null) {
        var style = edgeMatches[1];
        var start = edgeMatches[2];
        var end = edgeMatches[3];
        var startVertex = d.vertexById[start];
        var endVertex = d.vertexById[end];
        var e = new Diagrams.Edge(startVertex, endVertex);
        var data = {
            type: ZX.EDGETYPES.PLAIN,
...
exports.TikZtoZX = TikZtoZX;
/** IO module that exposes the TikZ code */
var ZXTikZIOModule = (function (_super) {
    __extends(ZXTikZIOModule, _super);
    function ZXTikZIOModule() {
        var _this = _super.call(this) || this;
        _this.importRewriteDiagram = function (diagram) {
            $(_this.UISelector).val(ZXToTikZ(diagram));
        };
        _this.onJSONChange = function () {
            var parsed;
            var packetDiagram;
            var inputString;
            try {
                inputString = $(_this.UISelector).val();
    ...
    return ZXTikZIOModule;
}(ZXIO.HTMLModule));
exports.ZXTikZIOModule = ZXTikZIOModule;

},{"./diagrams.js":4,"./zx-io.js":13,"./zx-theory.js":14,"jquery":16}],13:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
Object.defineProperty(exports, "__esModule", { value: true });
var IO = require("./diagrams-io.js");
// IO modules
/** Basic HTML IO module */
var HTMLModule = (function (_super) {
...
exports.defaultRadius = 10;

},{"./diagrams-io.js":3}],14:[function(require,module,exports){
"use strict";
